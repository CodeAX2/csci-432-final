        ...
        for(int i = 0; i < seating.getNumTables(); i++){
            ...
            for(int j = 0; j < n; j++){
                ...
                if(prev == null){
                    ...
                    //chooses the friend with the most enemies and no conflicts and adds them to the table
                ...
                //if not, then check if the person with the most enemies is an enemy of the table
            ...
            //If some seats didnt get filled in, then add people with most enemies left to that table.
